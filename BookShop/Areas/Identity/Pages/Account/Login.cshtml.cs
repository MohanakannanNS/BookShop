    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var value = _db.ApplicationUsers.FirstOrDefault(i => i.Email == Input.Email);
                    int count = _unitOfWork.ShoppingCart.GetAll(i => i.ApplicationUserId == value.Id).ToList().Count();
